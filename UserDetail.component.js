...
class UserDetail extends Component {
    ...
    handleInputChange = ( event ) => {
      ...
      datas.filter ( data => {
        if ( data.courseName.toLowerCase().includes ( searchedText.toLowerCase() ) ) {
    ...
    handleSelectCourse = (course, role) => {
        ...
        let coursesSelected = [];
        coursesSelected.push(roleName, course);
        console.log(coursesSelected[1]);
